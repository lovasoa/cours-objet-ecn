...
public void displayGameElement(Point2D pos, ImageIcon icon, String textIcon, String textZoneTexte) {
  ...
  XXXXXXXXXXX.setIcon(icon);
  XXXXXXXXXXX.setDisabledIcon(icon);
  XXXXXXXXXXX.setText(textIcon);
  XXXXXXXXXXX.setVerticalTextPosition(SwingConstants.CENTER);
  XXXXXXXXXXX.setHorizontalTextPosition(SwingConstants.CENTER);
  // Affichage dans le text area
  XXXXXXXXXXX.append(textZoneTexte+"\n");
}
